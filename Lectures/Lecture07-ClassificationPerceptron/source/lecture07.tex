...
\frametitle{A linear model for classification}
    Assume data is from $\mathbb R^d$ for some $d>0$ and we only have two labels, $\{1, -1\}$. %(e.g., this is Spam (\texttt{S}) or it is Not spam (\texttt{N})). 
    \pause
    ...
    \begin{figure}[h!]
        ...
        \begin{tikzpicture}[>=stealth, scale=0.7]
            ...
            \draw[green!70!black] (-2,1.8) --node[at end, right]{$\{0.8x+2y-2=0\}$} (2,0.2);
